const info = [

    {
        ...
        p_img1: './IMG/roupas/ternos/7.jpg', 
        p_img2: './IMG/roupas/ternos/7/1.jpg', 
        p_img3: './IMG/roupas/ternos/7/2.jpg', 
        p_img4: './IMG/roupas/ternos/7/3.jpg',  
    }
...
inicializarterno = () => {
    ...
    info.map((val)=>{
        ...
        //img1
        var imgAtual = "./IMG/roupas/ternos/7.jpg";
        var img = document.querySelector(".img").src = imgAtual;
        var img1 = document.querySelector(".img1");
        var srcIMG1 = "./IMG/roupas/ternos/7.jpg";
        ...
        var srcIMG2 = "./IMG/roupas/ternos/7/1.jpg";
        var img = document.querySelector(".img").src = imgAtual;
        ...
        var srcIMG3 = "./IMG/roupas/ternos/7/2.jpg";
        var img = document.querySelector(".img").src = imgAtual;
        ...
        var srcIMG4 = "./IMG/roupas/ternos/7/3.jpg";
        var img = document.querySelector(".img").src = imgAtual;
